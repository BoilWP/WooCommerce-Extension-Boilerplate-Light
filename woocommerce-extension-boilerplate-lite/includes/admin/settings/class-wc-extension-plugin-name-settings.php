<?php
/**
 * WooCommerce Extension Boilerplate Lite Settings
 *
...
if ( ! class_exists( 'WC_Extend_Plugin_Name_Settings' ) ) {

/**
 * WC_Extend_Plugin_Name_Settings
 */
class WC_Extend_Plugin_Name_Settings extends WC_Settings_Page {
...
return new WC_Extend_Plugin_Name_Settings();
